...
const Example = () => {
  ...
  return (
    <ExampleLayout
      title="Layout Animation — Scroll Invariance"
      description="The list is pushed far below the fold on purpose. Scroll down to it, then bump a score to trigger a reorder — the FLIP animation reads the element's real document position, not its viewport position, so scrolling the page in between two layout measurements no longer corrupts the animation (previously the scroll offset itself got misread as movement)."
    ...
    >
      ...
      >
        ↓ Scroll down to the ranking list, then bump a score ↓
      </div>
