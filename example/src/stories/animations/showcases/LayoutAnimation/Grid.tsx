...
const Example = () => {
  ...
  return (
    <ExampleLayout
      ...
      description="Toggle the filters or shuffle the grid — remaining cards smoothly animate to their new position and size using the `layout` prop, no manual transform math required."
      onRestart={() => {
