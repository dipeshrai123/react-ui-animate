...
const Example = () => {
  ...
  return (
    <ExampleLayout
      title="Flip Animation — Ranking List"
      description="Bump a player's score up or down — the list re-sorts and every row animates smoothly to its new rank using the `flip` prop, no manual position math required."
