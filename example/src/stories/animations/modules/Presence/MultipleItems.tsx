...
const Example: React.FC = () => {
  ...
  return (
    <ExampleLayout
      title="Presence with a List"
      description="Each list item gets its own exit animation when removed, so items animate out individually instead of the list just snapping to its new length."
