...
describe('isCssColorLiteral', () => {
  it('identifies valid named colors', () => {
    ...
    expect(isCssColorLiteral('blue')).toBe(true);
  });
...
describe('parseCssColor', () => {
  it('parses named colors to RGBA', () => {
    ...
    expect(parseCssColor('blue')).toEqual([0, 0, 255, 1]);
  });
  ...
  it('throws an error for unrecognized CSS colors', () => {
    ...
    expect(() => parseCssColor('aliceblue')).toThrow(
      'Unrecognized CSS color: aliceblue'
    );
